...
# returns True when enable_vault_secrets is set.
...
def test_set_encrypted_password_stores_plaintext_in_vault(
	...
	"""With enable_vault_secrets on, set_encrypted_password stores plaintext in vault.
	...
	monkeypatch.setitem(frappe.conf, "enable_vault_secrets", True)
