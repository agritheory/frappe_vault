...
def compare_and_sync(
	...
	# All None combinations were handled by the early returns above; assert so
	# mypy can narrow the union types for the comparisons that follow.
	assert local_time is not None and remote_time is not None  # noqa: S101
